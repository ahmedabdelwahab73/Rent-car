...
const TestAirportLocation = ({ activeSelected, selectedvalueLocation,
    defaultValue, records, loading, records_L_Location,
    selectedvalueStars, selectedvalueCarPrand, openLocationFromHome,
    selectedCarPrand,showListFilter, nameLocation}) => {
    ...
    }, [ records, selectedvalueLocation, selectedvalueCarPrand, selectedvalueStars, defaultValue,showListFilter,SizeScreen]);
    if(FilteredResult?.length ){
        ...
        return (
            loading ? 
            <div className='airport_indicator'>
                <Box sx={{ display: 'flex'}}>
...
export default TestAirportLocation;
