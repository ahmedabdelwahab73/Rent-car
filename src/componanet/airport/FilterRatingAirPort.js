...
const FilterRatingAirPort = ({params, selectedvalueStars, records, resultObject, activeSelected, selectedvalueLocation}) => {
    const [resultLocation, setResultLocation] = useState({});
    
    // const ckeckObject = Object.values(resultLocation)
    
    // console.log(ckeckObject[0]?.length);
    // // console.log(ckeckObject[0]);
    // useEffect(()=>{
    //     const result = {};
    //     result[selectedvalueStars] = records?.filter(value => (value.location === selectedvalueLocation )
    //     );
    //     setResultLocation(result);
    // },[records,selectedvalueStars ])
    ...
    //             values?.filter((item)=>{
    //                 if(activeSelected){
    //                 return (item?.stars >= Number(selectedvalueStars[0])) && (selectedvalueLocation === item?.location)
    //                 }
    //                 else{
    //                     return (item?.stars >= Number(selectedvalueStars[0])) && (item?.stars < Number(selectedvalueStars[0] +1))
    //                 }
    //             })      
    //             ?.map((item, index)=>{
    //                 return (
        ...
        return (
            ...
            {   
                values?.filter((item)=>{
                    ...
                    return  (item?.stars >= Number(selectedvalueStars[0])) && (item?.stars < Number(selectedvalueStars[0]) + 2 )
                    }
                })      
                ?.map((item, index)=>{
                    return (
...
export default FilterRatingAirPort